        ...
        for cci in range(-100, -80, 5):
            for rsi in (35, 45):
                ...
                if len(rsi_df) > 0:
                    ...
                    ll.append([dk, d, cci, rsi, min_principal, max_principal, true_times / total_times,
                               rsi_profits['principal'][-1:].values[0], total_times])

result = pd.DataFrame(ll, columns=['dk', 'd', 'cci', 'rsi', 'min_principal', 'max_principal', 'shooting',
