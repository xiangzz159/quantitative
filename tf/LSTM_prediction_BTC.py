...
@time: 2019/1/13 20:05

@desc: https://mp.weixin.qq.com/s?__biz=MzAxNTc0Mjg0Mg==&mid=2653290132&idx=1&sn=cbf1e2a4526e6e9305a6110c17063f46&chksm=802e3c81b759b597d3dd94b8008e150c90087567904a29c0c4b58d7be220a9ece2008956d5db&scene=0&xtrack=1#rd
...
model = build_lstm_model(X_train, output_size=1, neurons=lstm_neurons, dropout=dropput, loss=loss, optimizer=optimizer)
...
#                actual_returns[-n_points:][:-1],predicted_returns[-n_points:].shift(-1),
